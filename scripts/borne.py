...
def analysisByBorne(file_csv, file_result, file_sign, path):
    ...
    # If one of the signature is the absent in the other signatures
 ...
 # if attribute of formal concept is empty
    ...
    list_rest, dico_wt = writeFinalFile(path, dict_assoc, list_wt, all_objects)
