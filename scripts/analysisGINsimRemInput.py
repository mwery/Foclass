...
"""
	...
	Used if we test all inital states
...
#	fileResult="mutant"+str(fileName[:-6])+"txt"
	...
	#print(ginsimvers)
	cmd = "java -cp %s:scripts/extensions/jython-standalone-2.7.0.jar org.ginsim.Launcher -s ./scripts/ginsim/FindStableState.py %s > %s" %(ginsimvers[0], fileName, fileResult)
	os.system(cmd)
